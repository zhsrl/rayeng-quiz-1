          ...
          <div className="p-8 text-center animate-in fade-in duration-500">
            ...
            <p className="text-slate-600 mb-8">
              {score === questions.length 
                ? "Сіздің базалық біліміңіз өте жақсы! Менеджер сізбен хабарласып, бонусты WhatsApp-қа жібереді." 
                : "Қатысқаныңызға рақмет! Менеджер сізбен хабарласып, уәде етілген бонусты WhatsApp-қа жібереді."}
            </p>
